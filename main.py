...
# logo
tuplogo = gui.CTkImage(light_image=Image.open("res/logo1.png"), dark_image=Image.open("res/logo1.png"),size=(20, 20))
logo = gui.CTkButton(master = window, image=tuplogo, text="File Compressor", fg_color="transparent", hover=False)
